...
const STORAGE_KEY = "slide-controls-settings";
...
export const SlideControls = () => {
    ...
    return (
        <>
            <button className="slide-controls__toggle" onClick={() => changeVisibleHandler(!visible)}>
                ...
                <span className="slide-controls__toggle-text">Navigation</span>
            </button>
            <div className={clsx("slide-controls", { _visible: visible })}>
                <div className="slide-controls__left">
                    ...
                    <label
                        className={clsx("slide-controls__sync-label", {
                            "slide-controls__sync-label--visible": CONFIGURED_SERVER,
                        })}
                    >
                        <input
                            ref={register}
                        ...
                        />
                        <span className="slide-controls__sync-button">
                            <svg
                                width="20"
                                height="20"
                                viewBox="0 0 24 24"
                ...
                <div className="slide-controls__right">
                    <button
                        className="slide-controls__link"
                        onClick={() => {
                            navigator.share({
                                title: "SlideBook Presentation",
                                text: "SlideBook Presentation",
                    ...
                    <Link
                        href="/host"
                        className={clsx("slide-controls__host-link", {
                            "slide-controls__host-link--visible": CONFIGURED_SERVER,
                        })}
                    >
