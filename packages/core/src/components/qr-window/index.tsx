...
export interface QrWindowProps {
    className?: string;
    buttonClassName?: string;
}

export const QrWindow: React.FC<QrWindowProps> = ({ className }) => {
    ...
    return (
        <div
            className={clsx(
                "qr-window",
                {
                    "qr-window--visible": CONFIGURED_SERVER,
                },
                className,
            )}
        >
            <button className="qr-window-toggle" onClick={changeQrVisibleHandler}>
                ...
                <span className="qr-window-toggle__text">QR Code</span>
            </button>
            <div className="qr-window-content">
                <img
                    src={`${
                    ...
                    alt="QR Code"
                    loading="lazy"
                    className="qr-window-content__image"
                />
            </div>
        </div>
    );
