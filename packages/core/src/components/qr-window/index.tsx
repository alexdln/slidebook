...
export const QrWindow: React.FC<QrWindowProps> = ({ className, buttonClassName }) => {
    ...
    return (
        ...
        >
            <button className={clsx("qr-window-button", buttonClassName)} onClick={changeQrVisibleHandler}>
